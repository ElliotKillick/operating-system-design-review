...
foreach ($file in $dllFiles) {
    ...
    # Notice: Dumpbin output can subtly vary (I suppose there can be multiple import sections?):
    # dumpbin /imports output: "Section contains the following delay load imports:"
    # dumpbin /dependents output: "Image has the following delay load dependencies:"
