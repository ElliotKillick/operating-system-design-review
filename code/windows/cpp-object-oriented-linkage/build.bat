...
cl dll-test.cpp /DUNICODE /D_UNICODE /MD /LD /EHsc /Zi /DEBUG /link /INCREMENTAL:NO
cl exe-test.cpp /DUNICODE /D_UNICODE /MD /EHsc /Zi /DEBUG /link dll-test.lib /INCREMENTAL:NO
